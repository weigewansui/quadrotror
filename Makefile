...
# Source & Target
SOURCES     = navigation/hummingBirdState.c src/asctecCommIntf.c src/util.c src/filter_util.c\
 logger/logger.c logger/transmit_log.c control/main.c control/main_Vision.c logger/vicon_logger.c
...
$(EXECUTABLE): $(LCM_O) $(OBJECTS) 
	...
	$(CC) $(LFLAGS)-o bin/aci_recvar $(LCM_O) navigation/hummingBirdState.o $(ASCLIB) $(UTILS) $(LIBS) $(LDFLAGS)
	...
	$(CC) $(LFLAGS)-o bin/control_test $(LCM_O) control/main.o $(ASCLIB) $(UTILS) $(LIBS) $(LDFLAGS)
